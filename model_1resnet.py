...
# 6 -> residual block// Image Size 14 x 14 x filters_8res
filters_9res = filters_10res = 256
...
Y2_res = Y2_res + Y1_conv # Add input of resnet block
...
# Input image 14 x 14 x filters_8res
...
f = open('model_1resnet_evaluation.txt','w')
...
for epoch in range(epochs):
    ...
    for i in range(0, index, batch_size):
        ...
        sess.run(train_step, feed_dict = {X: batch_X, Y: batch_Y, training: True, pkeep: 0.5, pkeep_conv: 0.5, lr: learn_rate})
